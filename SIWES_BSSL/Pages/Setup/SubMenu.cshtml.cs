...
namespace SIWES_BSSL
{
    public class SubMenuModel : PageModel
    {
        ...
        public SubMenuModel(SIWES_BSSL.Data.ApplicationDbContext context,
        ...
        public List<Data.Menu.Menu> MenuList { get; set; }
        public List<Data.Menu.SubMenu> SubMenus { get; set; }
        public IList<Data.Menu.SubMenu> MainSubMenu { get; set; }
        [BindProperty]
        public Data.Menu.SubMenu SubMenu { get; set; }
        public string SubMenuName { get; set; }
        public IList<Data.Menu.Menu> Menus { get; set; }
