...
{ 
    ...
    public class CreateSchSuper : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (Input.Password.Any(Char.IsUpper) == false)
                ...
                if (useremail != null)
                {
                    errorm = "Supervisor already exist please check ";
                    return Page();
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user,ConstantRole.SchSuper);
