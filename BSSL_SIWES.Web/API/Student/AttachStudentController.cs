...
namespace BSSL_SIWES.Web.API.Student
{
    ...
    [ApiController]
    public class AttachStudentController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public AttachStudentController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/AttachStudent
        [HttpGet]
