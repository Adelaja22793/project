...
namespace BSSL_SIWES.Web.API.Student
{
    ...
    [ApiController]
    public class StudentBankDetailsController : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public StudentBankDetailsController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/StudentBankDetails
        [HttpGet]
        ...
        // DELETE: api/StudentBankDetails/5
        [HttpDelete("{id}")]
